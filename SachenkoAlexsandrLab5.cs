...
public class Program
{
    ...
    static (int, int) FindMaxIndex(int[,] A)
    {
        int max = A[0, 0];
    ...
    static int FindMaxInColumn(int[,] matr)
    {
    ...
    public long Task_1_1(int n, int k)
    {
        ...
        int candidates1 = 8;
        long ways1 = Combinations(candidates1, teamSize);

        int candidates2 = 10;
        long ways2 = Combinations(candidates2, teamSize);

        int candidates3 = 11;
        long ways3 = Combinations(candidates3, teamSize);
    ...
    public void Task_2_1(int[,] A, int[,] B)
    {
        ...
        int a1 = 0, b1 = 0;
        int a2 = 0, b2 = 0;
        (a1, b1) = FindMaxIndex(A);
        (a2, b2) = FindMaxIndex(B);
        (A[a1, b1], B[a2, b2]) = (B[a2, b2], A[a1, b1]);
    ...
    {
        // code here
        static int[,] SortRowsByMaxElement(int[,] matrix1)
        {
